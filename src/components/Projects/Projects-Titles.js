...
const projects = [
    {
      title: 'Arsenal Memes Galore',
      description: "Using just HTML and CSS to create a website that displays memes about Arsenal.",
      image: '/images/arsenalthmb.png',
      tags: ['HTML', 'CSS'],
      visit: 'https://arsenal-memes-galore.netlify.app/',
      id: 0,
    },
    {
      title: 'Blondiez & Browniez',
      description:"Using HTML, CSS and Vanilla JavaScript to replicate an e-commerce website.",
      image: '/images/BNBthmb.png',
